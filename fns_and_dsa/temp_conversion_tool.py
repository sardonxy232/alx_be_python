...
if __name__ == "__main__":
    main()
# This script demonstrates the use of global variables for conversion factors
# and provides a simple interface for converting temperatures between Celsius and Fahrenheit.
# It includes error handling for invalid inputs, ensuring a robust user experience.
# The conversion functions utilize the defined global factors to perform the calculations.
# The script is structured to be user-friendly, guiding the user through the conversion process