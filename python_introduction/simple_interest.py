...
# The code above defines three variables: principal, rate, and time, with values representing the principal amount, annual interest rate, and time in years, respectively.
# It then calculates the simple interest using the formula I = P * R * T and prints the result in a formatted string.